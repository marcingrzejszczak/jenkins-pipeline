...
If you want to provide another ip that your machine is visible at you can call
the `./whats_my_ip.sh` script.
...
[source,bash]
----
fly watch --job github-webhook/build-and-upload -t main
----
